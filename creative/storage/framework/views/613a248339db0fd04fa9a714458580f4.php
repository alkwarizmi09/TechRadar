                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarIcons">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="icons-lineawesome" class="nav-link"><span><?php echo app('translator')->get('translation.line-awesome'); ?></span></a>
                            </li>
                            <li class="nav-item">
...
<?php /**PATH E:\magang\test ui adminDashboard\Laravel\creative\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>